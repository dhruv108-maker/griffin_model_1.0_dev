...
class ReportEncoder:
    ...
    using a Sentence Transformer backbone.
    ...
    Output
    ------
    List[EvidenceToken] with populated:
        - embedding
        - embedding_model
        - embedding_dimension

    This stage performs ONLY semantic encoding.
    It does not modify any structural or semantic metadata.
    """
    ...
    def encode(
        ...
        for token, embedding in zip(tokens, embeddings):
            ...
            print("MODULE:", token.__class__.__module__)
            print("CLASS:", token.__class__)
            print("FIELDS:", token.model_fields.keys())
            print("DICT:", token.model_dump())
